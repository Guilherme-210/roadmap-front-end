...
- [[React - Fundamentos - Componentes e JSX]] — introdução apresentada em 2026-09-15; compreensão e aplicação aguardando validação.

## Prática e evidências

- [[React - Exercício 01 - Cartão de estudo]] — proposto, sem tentativa recebida.

## Dúvidas e próximas revisões

- Verificar componentes, JSX e expressões na primeira tentativa; depois avançar para props. Consulte [[Revisão contínua]]. Nenhum item amplo de 7.1 foi concluído.
